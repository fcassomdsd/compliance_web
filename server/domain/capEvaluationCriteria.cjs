// Source of truth for the IDAC-PAC-EVAL-01 "Evaluación del Plan de Acción
// Correctiva" checklist criteria. Mirrored manually (same dual-source
// convention as idFormats.cjs / documentCodes.js) at
// src/domain/capEvaluationCriteria.js for the frontend — keep both in sync
// if the catalog ever changes.
const CAP_EVALUATION_CRITERIA = [
  ...
  // measures section (see hasContainmentMeasuresData in caps/router.cjs).
...
module.exports = { CAP_EVALUATION_CRITERIA, CAP_EVALUATION_SECTIONS };
